...
class Users {
	...
	static public function Save($row){
		...
		static public function AddNew($row){
		...
		//Insert statement ( a new record )
		$sql = " Insert Into Users (FirstName, LastName, Password, UserType) "
         .      " Values ('$row2[FirstName]', '$row2[LastName]', '$row2[Password]', 5) ";
	...
	static public function Blank(){
		...
		return array('id'=> null, 'FirstName' => null , 'LastName' => null, 'Password' => null, 'Email' => null, 'UserType' => null);
	...
	static public function ValidateLogin($row){
		...
		$sql2 = "SELECT LastName From Users WHERE LastName='$lastName' ";
		
		$dbFirstName = fetch_one($sql);
		$dbLastName =  fetch_one($sql2);         
		
		if( isset( $dbFirstName) && isset($dbLastName)){
			
			if( $firstName != $dbFirstName['FirstName'] && $lastName != $dbLastName['LastName']){
				
				$errors['FirstName'] = 'doesnt match';
				$errors['LastName'] = 'doesnt match';
			}
