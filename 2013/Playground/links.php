  	   		...
  	   		<div class="navbar navbar-inverse navbar-fixed-top" role="navigation" >
					...
					<div class="collapse navbar-collapse nav-c">
			            <ul class="nav navbar-nav ">
			              ...
			              <li class="links active"><a href="links.php">Links</a></li>
			...
			<!-- main area -->
				...
				<div class="container">
					<div class="well">
						...
						<h1>Hello Links</h1>
						<p>Welcome to the Link section. <a class="btn btn-default "> More info </a></p>
							
					</div>
				
				
				<!-- media image and media body -->
					<div class="media">
		        		<a class="pull-left" href="http://www.dreamincode.net">
		        		  ...
		        		  <h4 class="media-heading">DreamInCode</h4>
	      			...
	      			<div class="media">
	      					...
	      					<a class="pull-left" href="http://www.stackoverflow.com">
	      						<img class="media-object" data-src="holder.js/64x64" alt="64x64" src="data:image/png;base64," style="width: 64px; height: 64px;">
	      					</a>
	      						<div class="media-body">
